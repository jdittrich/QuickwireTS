...
import { CompositeFigure, CreateCompositeFigureParam, CompositeFigureJson } from './figures/compositeFigure.js';
...
class Drawing extends CompositeFigure{
     ...
     */
    findEnclosingCompositeFigure(rect:Rect):CompositeFigure{
     ...
     */
    findEnclosedFigures(container:CompositeFigure,rect:Rect):Figure[]{
...
export {Drawing, CreateDrawingParam}
